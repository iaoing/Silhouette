...
# 2. Patch the IGNORE_STAT_ATTR_SET in env_nova.py
NOVA_ENV_FILE="../../../codebase/scripts/fs_conf/nova/env_nova.py"
NOVA_ENV_PATCH_CODE="
def ignore_stat_attr_set_path(self) -> set:
    return None

EnvNova.IGNORE_STAT_ATTR_SET = ignore_stat_attr_set_path
"
...
TEST_CASE="j-lang53"
# Do not dedup since some bugs in prefix operations will crash the VM and prevent the testing of other operations.

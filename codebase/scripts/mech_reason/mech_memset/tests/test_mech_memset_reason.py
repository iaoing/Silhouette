...
from logic_reason.mech.mech_memset.mech_memset_entry import MechMemsetEntry
from logic_reason.mech.mech_memset.mech_memset_reason import MechMemsetReason
...
def main(argc, argv):
    ...
    for split_entry in split_op_mgr.op_entry_list:
        ...
        memset_reason = MechMemsetReason(split_entry, pmstore_reason)
